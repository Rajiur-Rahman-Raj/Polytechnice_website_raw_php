                ...
                <div class="col-md-8 col-sm-12 col-12 pr-0">
                    <div class="admission">
                        ...
                        <?php 
                            ...
                            $useful_id = $_GET['useful_id'];

                            $get_single_useful_data = "SELECT * FROM `useful_links` WHERE id='$useful_id'";

                            $useful_query_result = mysqli_query($db,$get_single_useful_data);

                            $after_assoc = mysqli_fetch_assoc($useful_query_result);
                        ?>
